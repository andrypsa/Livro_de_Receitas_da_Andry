...
public class SolicitacaoAdministradorController {
        ...
        private final SolicitacaoAdministradorService solicitacaoAdministradorService;

        public SolicitacaoAdministradorController(
                        SolicitacaoAdministradorService solicitacaoAdministradorService) {

                this.solicitacaoAdministradorService = solicitacaoAdministradorService;
        }
        ...
        public ResponseEntity<ConviteAdministradorResponse> gerarConvite(
                ...
                SolicitacaoAdministrador convite = solicitacaoAdministradorService
                                .gerarConvite(
                                                dados.nome(),
                                                dados.email(),
                                                autenticacao.getName());

                ConviteAdministradorResponse resposta = new ConviteAdministradorResponse(
                                convite.getId(),
        ...
        public ResponseEntity<ConvitePublicoResponse> consultarConvite(
                ...
                ConvitePublicoResponse resposta = new ConvitePublicoResponse(
                                convite.getNomeConvidado(),
                                convite.getEmailConvidado(),
                                convite.getExpiraEm());
        ...
        public ResponseEntity<AdministradorCriadoResponse> concluirConvite(
                ...
                Administrador administrador = solicitacaoAdministradorService
                                .concluirConvite(
                                                token,
                                                dados.senha());
        ...
        private record ConcluirConviteRequest(
                        @NotBlank(message = "A senha é obrigatória.") @Size(min = 8, max = 100, message = "A senha deve ter entre 8 e 100 caracteres.") String senha) {
        }
